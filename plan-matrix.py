...
# Add or remove versions as needed based on mamba compatibility.
MAMBA_SUPPORTED_TORCH_VERSIONS = [
    "2.4.1",
    "2.5.1",
    "2.6.0",
    "2.7.1",
...
ARCH_TORCH_PAIRS = {
    "x86_64": ["2.4.1", "2.5.1", "2.6.0", "2.7.1", "2.8.0", "2.9.1", "2.10.0"],
    "aarch64": ["2.6.0", "2.7.1", "2.8.0", "2.9.1", "2.10.0"],
}
...
# 2.4-2.5 use FALSE, 2.6+ use TRUE
TORCH_CXX11_ABI = {
    "2.4": ["FALSE"],
    "2.5": ["FALSE"],
    "2.6": ["FALSE", "TRUE"],
...
def main() -> None:
    ...
    for target_arch, torch_versions in ARCH_TORCH_PAIRS.items():
        for torch_version in torch_versions:
            if torch_version not in MAMBA_SUPPORTED_TORCH_VERSIONS:
                continue
